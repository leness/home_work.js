...
// присваивание для параметра функции({ eyeColor })
...
const getUsersWithEyeColor = (array, color) => array.filter(array => array.eyeColor === color);
function getUserName ({eyeColor}) {return eyeColor};
