...
// // новый массив numbers и заполняет его числами из
// // массива array преобразованными функцией cb.

// // Оформи создание массива numbers нужной длины
// // используя new Array() и необходимый аргумент для
// // задания длины, равной длине array.
...
// // два параметра - element и index и возвращает
